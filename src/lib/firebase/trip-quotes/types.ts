...
const destinoBreakdownSchema = z.object({
  ...
  vueloIdaAdultoUsd: z.number(),
  vueloIdaMenorUsd: z.number(),
  vueloVueltaAdultoUsd: z.number(),
  vueloVueltaMenorUsd: z.number(),
  hotelAdultoUsd: z.number(),
  hotelMenorUsd: z.number(),
  experienciasAdultoUsd: z.number(),
  experienciasMenorUsd: z.number(),
  vueloIdaAdultoAdj: z.number(),
  vueloIdaMenorAdj: z.number(),
  vueloVueltaAdultoAdj: z.number(),
  vueloVueltaMenorAdj: z.number(),
  hotelAdultoAdj: z.number(),
  hotelMenorAdj: z.number(),
});
...
export const formulaResultSchema = z.object({
  ...
  precioAdultoBase: z.number(),
  precioMenorBase: z.number(),
  precioFinal: z.number(),
  margenVendedorUsd: z.number(),
  precioAdultoFinal: z.number(),
  precioMenorFinal: z.number(),
