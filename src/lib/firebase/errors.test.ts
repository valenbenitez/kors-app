...
describe("parseTripQuoteDoc", () => {
  ...
  const validResult = {
    ...
    margenAgenciaUsd: 10,
    precioPostFee: 120,
    precioAdultoBase: 120,
    precioMenorBase: 0,
    precioFinal: 120,
    margenVendedorUsd: 5,
    precioAdultoFinal: 126.32,
    precioMenorFinal: 0,
    ...
    destinos: [
      {
        ...
        vueloIdaAdultoUsd: 0,
        vueloIdaMenorUsd: 0,
        vueloVueltaAdultoUsd: 0,
        vueloVueltaMenorUsd: 0,
        hotelAdultoUsd: 0,
        hotelMenorUsd: 0,
        experienciasAdultoUsd: 100,
        experienciasMenorUsd: 0,
        vueloIdaAdultoAdj: 0,
        vueloIdaMenorAdj: 0,
        vueloVueltaAdultoAdj: 0,
        vueloVueltaMenorAdj: 0,
        hotelAdultoAdj: 0,
        hotelMenorAdj: 0,
      },
    ],
