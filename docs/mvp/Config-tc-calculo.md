...
> 💡 Fuente sugerida: dolarito.ar para ARS/USD — Wise o Google Finance para el resto.
> 
...
Esta tabla es **single source of truth** de los parámetros de fórmula. El SKILL.md `/cotizar-madero` Fase 2 lee estos valores en runtime junto con el TC del día — no hay duplicación en código. **Cambios aquí impactan inmediatamente en el próximo cálculo del agente sin tocar SKILL.md.**
